var coreyTheme = {
  ...
  tokenColors: [
    { name: 'Global settings', settings: { background: '#0F111A', foreground: '#babed8' } },
    ...
    { name: 'HTML entities', scope: 'punctuation.definition.entity.html', settings: { foreground: '#babed8' } },
    ...
    { name: 'C# namespace', scope: 'source.cs entity.name.type.namespace', settings: { foreground: '#babed8' } },
    { name: 'JSX Text', scope: 'meta.jsx.children, SXNested', settings: { foreground: '#babed8' } },
    ...
    { name: 'Markdown - Fenced Language', scope: ['markup.fenced_code.block'], settings: { foreground: '#babed890' } },
    {
  ...
  colors: {
    ...
    'editor.background': 'var(--color-highlight-background)',
